...
<body class="bg-gray-200 font-sans leading-normal tracking-normal">
    <nav class="relative bg-white border-b-2 border-gray-300 text-gray-900">
        <div class="container mx-auto flex justify-between">
            <div class="relative block p-4 lg:p-6 text-xl text-red-600 font-semibold">Logo</div>
            <ul class="flex">
                {{-- Tipe Properti --}}
                <li class="hoverable">
                            ...
                            <div class="mb-8 inline-block">
                                ...
                                <div class="sm:grid sm:grid-cols-2 sm:gap-3 lg:flex lg:space-x-5">
                                    ...
                                    <div class="inline-block p-3 ring-2 ring-slate-300 rounded-md">
                                        ...
                                        <div class="flex space-x-3">
                                            <span
                                                class="icon-[fa6-solid--shop] text-xl ms-1 text-red-600"></span>
                                    ...
                                    <div class="inline-block p-3 ring-2 ring-slate-300 rounded-md">
                                        ...
                                        <div class="flex space-x-3">
                                            <span
                                                class="icon-[lucide--land-plot] text-xl ms-1 text-red-600"></span>
                                    ...
                                    <div class="inline-block p-3 ring-2 ring-slate-300 rounded-md">
                                        ...
                                        <div class="flex space-x-3">
                                            <span
                                                class="icon-[vaadin--office] text-xl ms-1 text-red-600"></span>
            ...
            <ul class="flex">
                <li class="bg-red-500 cursor-pointer my-auto rounded-lg px-4 py-2 font-semibold text-white my-auto">
                    Contact Us
                </li>
            </ul>
        </div>
