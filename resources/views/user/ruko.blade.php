...
<body class="bg-white">
    ...
    <div class="relative">
        ...
        <div class="container absolute inset-x-[36rem]  top-[14rem] z-10  w-[40rem] ">
            <p class="text-4xl font-semibold ">Pilih Ruko Terbaik di Lokasi Strategis untuk Bisnis Anda!</p>
            <p class="text-lg mt-4">Wujudkan mimpi memiliki ruko idamanmu bersama Mitra Property Bogor. Mitra Property
        ...
        <div class="container absolute inset-x-0 p-[1.4rem] bg-white rounded-xl mx-auto -mt-20 z-10">
            <div class="flex">
                ...
                <div class="block ms-4">
                    <p class="font-semibold text-2xl">Cari Ruko yang anda inginkan</p>
    ...
    <div class="container flex items-center space-x-2 mt-28 mx-auto bg-[#F4BDB9] p-4 rounded-lg text-gray-600">
        @foreach ([['name' => 'Home', 'url' => '/'], ['name' => 'Ruko', 'url' => '/ruko']] as $link)
            @if ($loop->last)
                <span>{{ $link['name'] }}</span>
            @else
